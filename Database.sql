...
/****** Object:  Database [CookBook]    Script Date: 11/09/2022 6:58:04 pm ******/
CREATE DATABASE [CookBook]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CookBook', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\CookBook.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CookBook_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\CookBook_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [CookBook] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [CookBook] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
